...
const ScheduleAppointment = () => {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                const response = await axios.post(`${REACT_APP_API_URL}/patient/get-schedule`, { doctorId }, { withCredentials: true });
    ...
    const handleBookAppointment = async () => {
        ...
        try {
            ...
            await axios.post(`${REACT_APP_API_URL}/patient/book-appointment`, appointmentData, { withCredentials: true });
            console.log("toast ")
