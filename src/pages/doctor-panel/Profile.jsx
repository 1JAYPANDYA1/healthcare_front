...
const Profile = () => {
    ...
    useEffect(() => {
        if (patientData) {
            axios
                .post(`${process.env.REACT_APP_API_URL}/doctor/getprofile`, {
    ...
    const handleImageChange = (e) => {
        ...
        if (file) {
            ...
            if (!acceptedTypes.includes(file.type)) {
                showToast.error('Only JPG, JPEG, and PNG files are allowed', 'error');
                e.target.value = '';
                return;
            }
    ...
    const handleSubmit = async () => {
        try {
            ...
            await axios.post(`${process.env.REACT_APP_API_URL}/doctor/updateprofile`, {
                doctorId: patientData?.doctorId,
