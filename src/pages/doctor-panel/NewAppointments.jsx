...
const NewAppointments = () => {
  ...
  useEffect(() => {
    try {
      if (patientData?.doctorId) {
        axios.post(`${process.env.REACT_APP_API_URL}/doctor/pending`, { doctorId: patientData?.doctorId }, { withCredentials: true }).then((res) => {
  ...
  const AcceptRejectHandler = (appointmentId, status) => {
    try {
      axios.post(`${process.env.REACT_APP_API_URL}/doctor/status`, { appointmentId, status }, { withCredentials: true }).then((res) => {
    ...
    <div className="flex flex-col h-full" data-aos="zoom-in-up">
      ...
      <div className="md:px-6 py-2 w-full rounded-lg p-4">
        <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4 mb-4">
          <h1 className="text-xl md:text-2xl font-bold text-gray-700">New Appointments</h1>
            ...
            <div className="max-h-[72.5vh] overflow-y-auto">
              <table className="min-w-full border-collapse">
                ...
                <tbody>
                  ...
                  {filterPatients.length === 0 && !loader && (!startDate && !endDate && !searchPatient) && <tr><td colSpan="6" className="text-center py-4">No New Appointment(s) Found</td></tr>}
                ...
                <div className="w-full md:w-1/2 p-4 md:p-6 flex flex-col justify-between">
                  ...
                  <div className="flex gap-3 mt-4">
                    ...
                    <button
                      ...
                      className="flex-1 px-4 py-2 bg-red-500 text-white rounded hover:bg-red-600 text-sm md:text-base"
                    >
                      Reject
                    </button>
                  </div>
